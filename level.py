import pygame, game, json, block, fire, bear, heart, coin, flag, monster, oneUp
class Level():
    ...
    def __init__(self, file_path):
        ...
        for item in map_data['monsters']:
            x, y = item[0] * game.GRID_SIZE, item[1] * game.GRID_SIZE
            self.starting_enemies.append(monster.Monster(x, y, game.monster_images))
        ...
        if map_data['background-img'] != "":
            ...
            if map_data['background-fill-y']:
                ...
                background_img = pygame.transform.scale(background_img, (w, game.HEIGHT))
        ...
        if map_data['scenery-img'] != "":
            ...
            if map_data['scenery-fill-y']:
                ...
                scenery_img = pygame.transform.scale(scenery_img, (w, game.HEIGHT))
        ...
        self.active_sprites.add(self.coins, self.enemies, self.powerups, self.fires)
